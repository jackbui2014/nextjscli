...
const createComponent = (dir, componentName)=>{
  ...
  fileControl.createFileFromTemplate(path.join(__dirname, '/templates/components/component.scss.hbs'), dir+componentName+'/'+componentName+'.module.scss', componentName.toLowerCase());
}
